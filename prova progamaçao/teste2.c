            ...
            for(i = M; i <= N; i++){
                if(P % 2 == 0){
                   if(i % 2 == 0){ // Descobriremos se o valor da sentença é par, se sim vamos apresentar os valores que se encaixam dentro da variavel N(Maior) e M(menor).
                    ...
                    }else if(i % 2 != 0){ // Descobriremos o valor da sentença se é impar, se sim, apresentaremos os valores.
                       if(N-M == 1){
                            printf("%d.\n", i);
                        }else if(N - M == 3){
                            printf("%d e ", i);
                     ...
                     }else if(i % 2 == 0){ // Descobriremos se o valor da sentença é par, se sim vamos apresentar os valores que se encaixam dentro da variavel N(Maior) e M(menor).
                        if(N-M == 0){
                            printf("%d.\n", i);
                        }else if(N - M == 2){
                            printf("%d e ", i);
