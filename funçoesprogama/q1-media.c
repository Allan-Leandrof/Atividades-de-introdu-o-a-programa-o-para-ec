...
****/
int Media(int valor1, int valor2){ //* A media não está sendo calculada de forma correta pelo fato da função ser do tipo inteira e as variáveis também estarem declarando variáveis inteiras.
